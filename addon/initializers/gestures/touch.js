...
var allShadows = targetFinding.allShadows.bind(targetFinding);
  ...
  var touchEvents = {
    ...
    findTarget: function(touch, id) {
      if (this.currentTouchEvent.type === 'touchstart') {
        if (this.isPrimaryTouch(touch)) {
          ...
          return findTarget(fastPath);
        } else {
          return findTarget(touch);
        }
      }
    ...
    shouldScroll: function(inEvent) {
      if (this.firstXY) {
        var ret;
        var touchAction = targetFinding.findTouchAction(inEvent);
    ...
    up: function(inPointer) {
      inPointer.relatedTarget = findTarget(inPointer);
  ...
  document.addEventListener('click', function(ev) {
    ...
    var wasTouched = mouseEvents.lastTouches.some(closeTo);
    ...
    var path = targetFinding.path(ev);
    if (wasTouched) {
